...
net.Receive("ixInventoryFlipItem", function()
    ...
    local soundflip = {
		"eftsounds/backpack_drop_generic1.wav",
		"eftsounds/backpack_drop_generic3.wav",
		"eftsounds/backpack_drop_generic2.wav",
	}
	...
	if (character) then
		...
		if (inventory) then
			...
			surface.PlaySound(soundflip[math.random(#soundflip)])
		end
	end
end)
