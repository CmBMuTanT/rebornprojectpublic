...
function PLUGIN:PopulateRecipeTooltip(tooltip, recipe)
	...
	if recipe.CraftTime then
		local time = string.FormattedTime(recipe.CraftTime, "%02i:%02i" )
		local crafttime = tooltip:AddRow("crafttime")
		crafttime:SetText("Время на крафт займет: "..time.."")
		crafttime:SizeToContents()
	end
