RECIPE.name = "Суп «Плавающие лапки»"
RECIPE.description = "Вполне хороший суп! Приятно пахнет, и довольно хорошо насыщает.. Однако, готовить его в правильном ключе - умеет не каждый, да и ингридиентов не напасешься.."
...
RECIPE.requirements = {
	["rawmeat_sobakalegs"] = 1, 
	["bullion"] = 1,
	["bankazakatka"] = 1,
	["tableware_smallplate"] = 1,-- что необходимо для крафта
}

RECIPE.results = {
	["shitfood_soap"] = 1 -- что получаешь
}

RECIPE.CraftTime = 95-- Как долго будет крафтится предмет (в секундах) (false если мгновенный крафт.)
