RECIPE.name = "Яичница"
RECIPE.description = "Ужасно липко! Бргх! Яблоко явно испорченное.. Но, нисмотря на все выше перечисленные недостатки - вполне насыщаемое блюдо, и явно стоит своих денег.."
...
RECIPE.results = {
	["shitfood_eggpenis"] = 1 -- что получаешь
}
