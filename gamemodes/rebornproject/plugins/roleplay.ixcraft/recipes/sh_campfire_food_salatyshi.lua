RECIPE.name = "Салат «Тухлая Катя»"
RECIPE.description = "Один из самых распространённых салатов в Метрополитене! На вкус - отвратителен, и практически не насыщает.. Однако - очень дешёв в производстве!"
...
RECIPE.results = {
	["shitfood_salatover"] = 1 -- что получаешь
}
