ITEM.name = "Семена быстрорастущей картошки"
ITEM.description = "Семена - что были разработаны на Полисе, как вариант решения выращивания овощевой пищи. Конечно, картошку это напоминает очень отдаленно - но, вцелом съедобно"
...
ITEM.functions.Use = {
	...
	OnRun = function(item)
        ...
        local mushrooment = ents.Create( "ix_mtk_potato" )
