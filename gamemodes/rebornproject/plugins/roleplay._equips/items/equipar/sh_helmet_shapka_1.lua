...
ITEM.description = "Думаю, никакого описания тут не требуется.. Простая зеленая шапка, выглядит изношенно, и.. Кажется, что она уже утратила свой первоначальный цвет.."
