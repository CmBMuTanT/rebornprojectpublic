ITEM.name = "Бронекомплект «БАРД»"
ITEM.description = "Бронекомплект представляющий из себя набор тёплой одежды с подвешенным спереди добротным бронежилетом, с не менее добротными бронепластинами! Имеет высокий спрос практически ВЕЗДЕ - где только есть человек с оружием, несущий службу. Это не бронекомплект - это идеал!.."
