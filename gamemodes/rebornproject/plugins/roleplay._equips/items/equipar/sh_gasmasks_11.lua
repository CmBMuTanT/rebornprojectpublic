ITEM.name = "ТЗВ-4"
ITEM.description = "Средство защиты органов дыхания, зрения и кожи лица. По сравнению с коллективными средствами защиты, он менее эффективен Условия использования влияют на срок службы противогазного фильтра. "
...
ITEM.bodyGroups = {
    ["Противогазы,маски,респираторы"] = 11,
}
