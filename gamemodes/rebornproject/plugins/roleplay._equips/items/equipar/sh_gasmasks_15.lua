ITEM.name = "ГП-22.1-КУСТАРНЫЙ"
ITEM.description = "Прототип противогаза ГП-5 с ухудшенными вставками для фильтров,  Противогаз так-же массивен, исправен и готов исполнять свою функцию."
...
ITEM.bodyGroups = {
    ["Противогазы,маски,респираторы"] = 15,
}
