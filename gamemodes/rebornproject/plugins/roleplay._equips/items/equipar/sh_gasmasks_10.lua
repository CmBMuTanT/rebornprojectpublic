ITEM.name = "ГП-8-ВНУТРЕННИЙ"
ITEM.description = "Прототип противогаза ГП-9 с внутренней системой фильтрации, что улучшает легкость противогаза и его нагроможденность."
...
ITEM.bodyGroups = {
    ["Противогазы,маски,респираторы"] = 10,
}
