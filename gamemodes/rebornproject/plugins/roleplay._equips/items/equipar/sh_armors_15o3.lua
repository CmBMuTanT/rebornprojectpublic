ITEM.name = "Боевой комплект «МИРОТВОРЕЦ-П»"
ITEM.description = "Принят на вооружение Полисом в тот же день что и Спартой, носится данный бронекомплект, к слову - в подавляющем в том-же Ордене. Имеет голубовато-синюю окраску, нашивку на спине и по-рукам, базовые бронепластины и какую-никакую тепло-ветрозащиту. Выглядит вполне ново, что и добавляет не только антуражности бойцам на стимуле силы и объединенности - но и общие показатели качества в плюсовую сторону."
