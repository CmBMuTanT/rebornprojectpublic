...
ITEM.description = "Самые простые довоенные штаны, которые вполне хорошо сохранились для своего времени!.. Сзади видна бирка, вот только слов на ней уже не разобрать - да оно и не нужно, какая разница что за бирка на твоей одежде?.."
