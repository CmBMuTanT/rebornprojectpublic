ITEM.name = "Штаны «ЖНЕЦ-5 | ПС»"
ITEM.description = "Тактические штаны цвета песка. Ранее, были популязированы в ношении у силовых структур типа `ВССЕ`, и ему подобных. Удобны в ношении, и имеют плотную ткань - за счёт чего обеспечивают какую-никакую защиту от порезов."
...
----Skin Gropus----
ITEM.SGname = "sg_bandit_2_nogi" -- название SkinGroup
