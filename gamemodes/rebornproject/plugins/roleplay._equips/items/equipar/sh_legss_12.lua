ITEM.name = "Тактические штаны «ПОХОД»"
ITEM.description = "Линейка штанов «ПОХОД» обрела свою популярность на «Рижской», поговаривают - что к разработке этих штанов приложили руку наёмные ученые Полиса.. Сами по себе штаны хороши, обеспечивают защиту от порезов и падений - теплые и удобные."
