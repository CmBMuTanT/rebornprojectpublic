ITEM.name = "Бронекомплект «БИВЕНЬ-ОФФИЦЕРСКИЙ»"
ITEM.description = "Один из самых тяжёлых штурмовых бронекомплектов армейской модернизации на станциях СССС. Данный бронекомплект был разработан специально для привелигированных отрядов дислоцирующихся на базе штурмовых отрядов - для большей безопасности государства социализма в стенах Метро!.. Сам бронекомплект показал себя вполне хорошо, и более того - его чертежи были проданы почти всем ведущим фракциям-государствам, что уже говорит о высоком спросе на него в рядах ВС."
