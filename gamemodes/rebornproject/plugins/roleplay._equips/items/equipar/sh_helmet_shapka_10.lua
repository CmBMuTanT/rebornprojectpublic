ITEM.name = "Кепка `МЕТРОМАХТ`"
ITEM.description = "Утеплённая кепка - которая закреплена в ношении для офицеров Метромахта, выглядит ново - и.. Даёт надежду на очищение рода славянского. Не так-ли?"
