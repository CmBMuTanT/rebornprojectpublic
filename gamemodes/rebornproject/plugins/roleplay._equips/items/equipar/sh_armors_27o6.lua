ITEM.name = "Бронекомплект «КОРЕНЬ-Ш»"
ITEM.description = "Один из самых тяжёлых штурмовых бронекомплектов армейской модернизации на станциях Рейха. Данный бронекомплект был разработан специально для привелигированных отрядов дислоцирующихся на Пушкинской - для большей безопасности столицы-оплотницы национализма в стенах Метро!.. Сам бронекомплект показал себя вполне хорошо, и более того - его чертежи были проданы почти всем ведущим фракциям-государствам, что уже говорит о высоком спросе на него в рядах ВС."
