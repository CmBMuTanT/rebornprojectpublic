...
ITEM.description = "Доработанная версия штанов «ПОХОД», помимо хорошего материала что защищает от порезов и облегчает урон от падений - в эти штаны вшиты небольшие противопулевые пластины. Возможно, из-за этого пострадал показатель удобности и веса - но, защита всяко важнее."
