...
ITEM.description = "Имеет чёрный окрас! Принята на вооружение Спартой, и носится в подавляющем ей же. Имеет голубовато-синюю окраску, базовые бронепластины - и какую-никакую тепло-ветрозащиту. Выглядит вполне ново, что и добавляет не только антуражности бойцам на стимуле силы и объединенности - но и общие показатели качества в плюсовую сторону."
