...
function PANEL:Init()
	...
	deleteConfirm.DoClick = function()
        ...
        if self.character:GetMoney() >= moneys or banned then -- and yes
            ...
            parent:ShowNotice(3, L("Невозможно удалить персонажа, так как на нем недостаточно средств! (хехе система антиабуза соснул хуйца продакшен)"))

            --[[
                не вижу смысла нет.старт сюда вставлять, да и все равно проверка в sh_plugin имеется тоже на ДДДЕНЬГИ
            ]]
        end
	end
