...
ITEM.name = "АА-батарейка"
ITEM.description = "Обыкновенная АА батарейка, нужна для подпитки чего то."
...
ITEM.functions.use = {
    ...
    multiOptions = function( item, client )
        ...
        for k, v in next, client:GetCharacter():GetInventory():GetItems() do
            if PLUGIN.itemstocharge[v.uniqueID] and v.uniqueID != "recharger" then
