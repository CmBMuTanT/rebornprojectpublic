...
ix.lang.AddTable("english", {
	...
	optLegsEnabled = "Включить показывания ног",
	optLegsInVehicle = "Показывать ноги в машине"
})
...
if (CLIENT) then
	...
	function Legs:FixBones()
        if !self.LegEnt then return end
