ITEM.name = "Метамфетамин"
ITEM.description = "Кристаллы белого цвета, довольно прозрачные, Видимо их нужно чем нибудь раздробить дабы принять интраназально."
