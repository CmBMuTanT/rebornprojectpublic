...
local function PermissionLoad()
	...
	PermaProps.Permissions["owner"] = { Physgun = true, Tool = true, Property = true, Save = true, Delete = true, Update = true, Menu = true, Permissions = true, Inherits = "superadmin", Custom = true }
	PermaProps.Permissions["founder"] = { Physgun = true, Tool = true, Property = true, Save = true, Delete = true, Update = true, Menu = true, Permissions = true, Inherits = "superadmin", Custom = true }
...
local function pp_info_send( um, ply )
	...
	elseif Content["CMD"] == "VAR" then
		...
		if Content["Name"] == "founder" and  ( Content["Data"] == "Custom" or Content["Data"] == "Permissions" or Content["Data"] == "Menu" ) then return end
