...
SKIN.PrintName		= "MapPatcher Skin"
SKIN.Author		= "H3xCat"
SKIN.DermaVersion	= 1
...
SKIN.Colours.Label = {}
SKIN.Colours.Label.Default			= Color( 255, 255, 255 )--GWEN.TextureColor( 4 + 8 * 8, 508 )
...
derma.DefineSkin( "MapPatcher", "Skin for MapPatcher menu", SKIN )